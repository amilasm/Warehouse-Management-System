...
export default function Tracking() {
  ...
  const generatePDF = tickets => {
    ...
    <table class="table table-bordered">
        ...
        </div></>:supplier.role === "admin"?<body onload={myFunction()}/>:supplier.role === "supplier"?<body onload={myFunction()}/>:supplier.role === "agent"?<body onload={myFunction2()}/>:<div class="d-flex justify-content-center">
