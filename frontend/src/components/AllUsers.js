...
useEffect(()=>{
  const getSupplier = async()=>{
   const res = await axios.get('/supplier/alluser').then((res)=>{
...
return(
  ...
  <div className="head">
    ...
    <div className="allsupcard1">
      ...
      <h1 style={{ fontFamily: "Arial,Helvetica,sans-serif", fontWeight: "bold" }}>All Users</h1>
      <br/>
             ...
             <table class="table table-hover" >
               ...
               {supplier.filter(val=>{
                ...
                <tr key={key}>      
                  ...
                  <td className="damfont">{supplier.role}</td>
